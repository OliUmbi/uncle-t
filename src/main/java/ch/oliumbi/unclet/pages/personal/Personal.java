    ...
    return List.of(
        ...
        new Section(
            new Split(
                ...
                new PersonalGroup(
                    new P("Ein Candle-Light-Dinner zu Zweit, eine familiäre Feier oder eine extravagante Veranstaltung – als Privatkoch möchte ich Ihnen und Ihren Gästen ein kulinarisches Erlebnis anbieten, das Sie so schnell nicht vergessen werden. "),
        ...
        new Section(
            new Split(
                new PersonalGroup(
                    new P("Als Privatkoch übernehme ich die gesamte Planung, den Einkauf und die Zubereitung ihres Menüs, damit Sie sich entspannt zurücklehnen und eine schöne Zeit mit ihren Gästen verbringen können."),
