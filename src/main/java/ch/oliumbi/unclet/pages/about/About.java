        ...
        new Section(
            new Split(
                ...
                new AboutGroup(
                    ...
                    new P("Heute bin ich Stolz darauf meine eigene Firma gegründet zu haben in der ich meine Leidenschaft mit anderen teilenm kann.")
                )
            )
        ),
        new Article(
            new AboutGroup(
                new P("Auf meine Homepage findest du einen Einblick in meine Kochphilosophie, meine Dienstleistungen und vielleicht auch die Inspiration für dein nächstes kulinarisches Abenteuer."),
                new P("Ich lade dich herzlich ein, mich auf dieser aufregenden Reise zu begleiten und freue mich darauf, deine Geschmackssinne zu verwöhnen.")
            )
         ),
        new Article(
            new Contact()
